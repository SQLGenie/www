...
<body>
	...
	<?php endif; ?>
		...
		<form action="TestContribute2.php" method="POST">
...
<form action="just-stripe.php" method="POST">
  <script
    src="https://checkout.stripe.com/checkout.js" class="stripe-button"
    data-key="pk_test_AVQli84ydZSwVDImMrNv6aZW"
    data-amount="2000"
    data-name="Committee to elect Carol Fey "
