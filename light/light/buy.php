...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (empty($errors)) {
		...
		try {
			...
			\Stripe\Stripe::setApiKey("pk_test_AVQli84ydZSwVDImMrNv6aZW");
...
echo '<script type="text/javascript">Stripe.setPublishableKey("' . "pk_test_AVQli84ydZSwVDImMrNv6aZW" . '");</script>';
?>
