...
if(!empty($_POST['email']) && !empty($_POST['Occupation'])):
	...
	//$sql = "INSERT INTO voters (email, Fname, Lname, Occupation) VALUES (:email, :Fname, :Lname, :Occupation)";
 	$sql = "INSERT INTO voters(email, Fname, Lname, Address, Zip, Occupation) VALUES (:email, :Fname, :Lname, :Adderess, :Zip, :Occupation)";	
...
<body>
	...
	<?php endif; ?>
		...
		<input type="text" placeholder="Enter your Occupation" name="Address">
		<input type="text" placeholder="Enter your Occupation" name="Zip">
	...
	<h1>Register</h1>
		...
		<h2 class="fh5co-uppercase-heading-sm text-left">Mail Address
